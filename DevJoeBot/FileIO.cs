...
namespace DevJoeBot
{
    static class FileIO
    {
        public static void SaveFile(string path, SaveableSettings toSave)
        {
        ...
        public static SaveableSettings LoadFile(string path)
        {
            using (FileStream fs = new FileStream(path, FileMode.Open, FileAccess.Read))
            {
                return Deserialize<SaveableSettings>(fs);
            }
        }
